...
var DefaultDomCompiler = (function (_super) {
    ...
    DefaultDomCompiler = __decorate([
        ...
        __metadata('design:paramtypes', [element_schema_registry_1.ElementSchemaRegistry, template_cloner_1.TemplateCloner, (typeof (_a = typeof change_detection_1.Parser !== 'undefined' && change_detection_1.Parser) === 'function' && _a) || Object, (typeof (_b = typeof view_loader_1.ViewLoader !== 'undefined' && view_loader_1.ViewLoader) === 'function' && _b) || Object, shared_styles_host_1.SharedStylesHost, Object])
    ], DefaultDomCompiler);
