...
var ViewLoader = (function () {
    ...
    ViewLoader = __decorate([
        di_1.Injectable(), 
        __metadata('design:paramtypes', [(typeof (_a = typeof xhr_1.XHR !== 'undefined' && xhr_1.XHR) === 'function' && _a) || Object, style_inliner_1.StyleInliner, style_url_resolver_1.StyleUrlResolver])
    ], ViewLoader);
    return ViewLoader;
    var _a;
})();
