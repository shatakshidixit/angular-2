...
var StyleInliner = (function () {
    ...
    StyleInliner = __decorate([
        di_1.Injectable(), 
        __metadata('design:paramtypes', [(typeof (_a = typeof xhr_1.XHR !== 'undefined' && xhr_1.XHR) === 'function' && _a) || Object, style_url_resolver_1.StyleUrlResolver, (typeof (_b = typeof url_resolver_1.UrlResolver !== 'undefined' && url_resolver_1.UrlResolver) === 'function' && _b) || Object])
    ], StyleInliner);
    return StyleInliner;
    var _a, _b;
})();
